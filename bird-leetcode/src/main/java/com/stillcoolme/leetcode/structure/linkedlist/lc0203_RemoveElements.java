...
public class lc0203_RemoveElements {
    ...
    public static void main(String[] args) {
        ...
        lc0203_RemoveElements lc0203_RemoveElements = new lc0203_RemoveElements();
        ListNode listNode = lc0203_RemoveElements.removeElements(listNode66, 6);
